...
function NavModalItem({ to, img, title, onMouseOver, onMouseOut }) {
    return (
        <NavLink
            ...
            to={to}
            className="navmodal-item border-r-1 border-[#c3cedb] flex items-center py-2 pr-0 pl-4 hover:bg-[#edf2f8] hover:text-[#072D94] hover:font-bold hover:border-y-1 hover:border-x-0 hover:border-[#c3cedb] transition-all ease-linear	"
        >
