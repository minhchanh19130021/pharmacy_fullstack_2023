...
function DetailList() {
    ...
    return (
        <div className="grid 2xl:grid-cols-4 xl:grid-cols-4 lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 xs:grid-cols-2  gap-6 px-1">
            <div className="detail-list bg-[#d4edfa] border-b rounded-lg h-[350px] sticky top-0 2xl:block xl:block lg:block md:hidden sm:hidden xs:hidden ">
                <div className="px-4 py-3 cursor-pointer flex items-center border-b border-[#d8e0e8]">
                    ...
                    <span className="capitalize font-medium"> Nội dung chính</span>
                </div>
                <ul className="px-2 py-2">
                    <li
                        className="px-2 py-[8px] cursor-pointer hover:bg-[#fff] hover:rounded-xl hover:border hover:border-[#e4eaf1] hover:shadow-xl hover:font-medium 
            hover:px-4 hover:py-[6px] "
                        onClick={() => {
            ...
            <div className="detail col-span-3">
                ...
                <ReactShowMoreText
                    ...
                    anchorClass="cursor-pointer hover:underline bg-[rgb(255,255,255,0.3)] text-[#333] block text-center my-4  "
                ...
                >
                    <div className="ingredient mb-3" ref={refScrollIngredient}>
                        ...
                        <div className="ingredient-desc">
                            <p className="mb-4">
                                <span className="text-[#718198] ">Lysine</span>: Giúp ăn ngon miệng; giảm lo lắng do
                                chặn các thụ thể liên quan đến phản ứng căng thẳng; cải thiện hấp thụ canxi giúp tăng
                                cường chiều cao, ngăn ngừa bệnh còi xương, loãng xương.
                            </p>
                            <p className="mb-4">
                                <span className="text-[#718198] ">L-Arginin:</span>: Là acid amin bán cần thiết, hay còn
                                gọi là acid amin thiết yếu có điều kiện. Trong cơ thể arginine được tổng hợp từ
                                Citrulline. Có tác dụng cải thiện chức năng tình dục, làm tăng số lượng và chất lượng
                                tinh trùng. Tăng quá trình lành vết thương và liền xương, phục hồi nhanh các mô bị tổn
                                thương, hư hỏng. Hạ huyết áp, tăng tuần hoàn máu tới các tổ chức.
                            </p>
                            <p className="mb-4">
                                <span className="text-[#718198] ">Lysine</span>: Giúp ăn ngon miệng; giảm lo lắng do
                                chặn các thụ thể liên quan đến phản ứng căng thẳng; cải thiện hấp thụ canxi giúp tăng
                    ...
                    <div className="dosage" ref={refScrollDosage}>
                        ...
                        <p className="font-medium mb-4">Cách dùng</p>
                        <ul>
                        ...
                        <p className="font-medium mb-4">Đối tượng sử dụng</p>
                        <ul>
                            <li className="mb-4">
                    ...
                    <div className="note border border-[#b6c0ce] rounded-lg px-3 py-3 mb-6" ref={refScrollNote}>
                        ...
                        <ul className="pt-3">
                            <li className="mb-2">
                                Không dùng cho người mẫn cảm với bất kỳ thành phần nào của sản phẩm.
                            </li>
                            <li className="mb-2">
                ...
                <div className="approve flex items-center mt-9 bg-[#edf2f8] border-[#bee3f8] rounded-lg   py-3 px-4 ">
                    ...
                    <div className="approve-detail">
                        <div className="approve-detail__header flex items-center justify-between pb-2 border-b">
                            <p className="text-xl font-medium">Dược sĩ Đại học Nguyễn Thanh Hải</p>
