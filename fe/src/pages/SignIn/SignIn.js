            ...
            <div className="border-2 sm:w-2/4 max-sm:w-full sm:my-10 p-8 rounded-xl">
                ...
                <div>
                        ...
                        <Form className="my-3">
                            ...
                            <div className="relative bg-white">
                                <input
                                    ...
                                    className="block h-12 outline-0 rounded-xl w-full border-b focus:border-b-2 focus:border-sky-500 duration-100 ease-in my-5 px-2 rounded-lg w-full"
                                    name="password"
                            ...
                            <NavLink
                                to="/forgotPassword"
                                className="cursor-pointer underline text-zinc-500 my-3"
                            >
                                Quên mật khẩu
                            </NavLink>
                            <button
                    ...
                    <div className="text-lg">
                        <span className="font-bold">Chưa có tài khoản </span>
                        <NavLink
                            to="/signUp"
