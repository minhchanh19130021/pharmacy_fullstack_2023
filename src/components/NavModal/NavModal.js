    ...
    return (
        <div className="wrapper-navmodal flex flex-wrap shadow-lg ">
            ...
            <div className="w-9/12 px-4 py-4">
                <div className="flex flex-wrap mx-[-4px] border-[#d8e0e8] border-b-2 ">
                    <div className="px-1 max-w-[25%] flex-[0_0_25%] ">
                        <NavLink
                            to=""
                            className="flex items-center rounded-3xl border-[#c3cedb] bg-[#fff] pt-1 pr-4 pb-1 pl-1  mb-2"
                        >
                            <picture className="px-2 py-2 hover:rounded-full w-10 h-10 mr-2">
                                <img
                                    src="https://cdn.nhathuoclongchau.com.vn/unsafe/fit-in/80x80/filters:quality(90):fill(white)/https://nhathuoclongchau.com.vn/images/category/20221012091059-9023.png"
                ...
                <div className="best-seller pt-3 px-4 pb-4">
                    ...
                    <div className="flex flex-wrap">
                        <div className="max-w-[20%] flex-[0_0_20%] px-1">
                            <ProductSeller
